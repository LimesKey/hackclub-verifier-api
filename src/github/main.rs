use crate::{GitHubApiResponse, GithubOauth};
...
impl GithubOauth {
    pub async fn process_github_oauth(&self, code: String) -> Result<GitHubApiResponse, String> {
        ...
        let token_params: HashMap<String, String> =
            url::form_urlencoded::parse(token_text.as_bytes())
                .into_owned()
                .collect();
